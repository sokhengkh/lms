        ...
        <div className='bg-slate-50 dark:bg-slate-900 text-black dark:text-white dark:border-white py-5 px-4 md:px-16'>
            <div className='max-w-7xl mx-auto flex flex-col md:flex-row items-center space-y-12 md:space-y-0 md:space-x-8'>
                <div className='flex-1'>
                    ...
                    <p className='leading-relaxed mb-8 mt-8'>
                    ...
                    <div className='flex flex-wrap gap-4'>
                        <a href="#" className='bg-fuchsia-500 text-white font-bold px-6 py-3 rounded-lg shadow hover:bg-fuchsia-800 transition'>
                            Contact Us
                        </a>

                        <a href="#" className='bg-gray-500 font-bold text-white px-6 py-3 rounded-lg shadow hover:bg-gray-800 transition'>
                            Call for Support
                        </a>
                    </div>
                </div>
