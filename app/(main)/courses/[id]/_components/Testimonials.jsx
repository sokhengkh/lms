...
const Testimonials = () => {
    return (
        ...
        <div className="container">
          ...
          >
            <CarouselPrevious className='dark:bg-white dark:text-black bg-gray-300 text-black' />
            <CarouselNext className='dark:bg-white dark:text-black bg-gray-300 text-black' />
