...
const CourseDetails = () => {
    return (
        ...
        <div className="container">
          <span className="bg-green-500 dark:bg-gray-200 px-4 py-0.5 rounded-full text-xs font-medium dark:text-black text-white inline-block">
            Development
          </span>
          ...
          <div className="my-6">
            <Tabs defaultValue="overview" className="w-full">
              ...
              <TabsContent value="instructor">
                ...
                <div className="bg-gray-50 dark:bg-black rounded-md p-8">
