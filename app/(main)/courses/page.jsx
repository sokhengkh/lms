                  ...
                  <ul className="space-y-4">
                    {CATEGORY_OPTIONS.map((option, optionIdx) => (
                      <li key={option.value} className="flex items-center">
                        ...
                        <label
                          htmlFor={`category-${optionIdx}`}
                          className="ml-3 text-sm text-gray-600 dark:text-gray-200 cursor-pointer"
                        >
                          {option.label}
                        </label>
                      </li>
                  ...
                  <div className="group hover:shadow-sm transition overflow-hidden border rounded-lg p-3 h-full">
                    ...
                    <div className="flex flex-col pt-2">
                      ...
                      <div className="flex items-center justify-between mt-4">
                        <p className="text-md md:text-sm font-medium text-slate-700 dark:text-gray-200">
                          {formatPrice(49)}
                        </p>

                        <Button
                          variant="ghost"
                          className="text-xs text-sky-700 h-7 gap-1 dark:text-gray-200"
                        >
                          Enroll
